...
\begin{table}[htbp]
\centering
\caption{Mie validation on a plasmonic gold sphere.
  $m_{\text{Au}} = 0.18 + 3.07\,i$,
  $\lambda_0 = \SI{0.638}{\micro\metre}$, $x = k_0 r = 0.63$,
  $r \approx \SI{0.064}{\micro\metre}$.
  Errors: cross-section columns show $|\Delta C|/C_{\text{Mie}}$,
  amplitude columns $|\Delta S|/|S|_{\text{Mie}}$.
  Half-SWG basis, Duffy rule order~5.}
\label{tab:au-mie}
\footnotesize
