...
<!-- VERSION-BADGE-START (bump alongside Project.toml on release) -->
[![Version](https://img.shields.io/badge/version-v0.6.0-blue.svg)](https://github.com/NobuhiroMoteki/block-VIEM.jl/releases)
<!-- VERSION-BADGE-END -->
